...
import com.chrono.ssh.core.vnc.protocol.Encodable
import com.chrono.ssh.core.vnc.protocol.FramebufferUpdateRequest
import com.chrono.ssh.core.vnc.protocol.KeyEvent
import com.chrono.ssh.core.vnc.protocol.PixelFormat
import com.chrono.ssh.core.vnc.protocol.PointerEvent
import com.chrono.ssh.core.vnc.protocol.ClientCutText
import com.chrono.ssh.core.vnc.protocol.ProtocolVersion
import com.chrono.ssh.core.vnc.protocol.ServerInit
...
class VncSession(
    ...
    /**
     * Set by [VncClient] post-handshake to the [com.chrono.ssh.core.vnc.io.CountingInputStream]
     * that wraps [inputStream]. Used by the bandwidth-suggestion feature
     * (#107) to estimate session throughput.
     */
    var bandwidthCounter: com.chrono.ssh.core.vnc.io.CountingInputStream? = null
        internal set
